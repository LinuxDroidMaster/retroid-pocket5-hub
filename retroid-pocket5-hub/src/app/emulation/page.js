...
export default function EmulationPage() {
  return (
    ...
    {/* SEGA Section */}
    <SectionGroup title="SEGA">
        <EmuCard
          system="Dreamcast"
          note="Download Redream from the Play Store. Excellent performance."
          buttons={[
            { label: "Download Redream", href: "https://play.google.com/store/apps/details?id=io.recompiled.redream&hl=es_419", color: "purple" },
            { label: "Guide", href: "https://youtu.be/I4mqgcDYZFo?t=2401", color: "blue" },
          ]}
        />
        <EmuCard
          system="Sega Saturn"
          note="Use Yaba Sanshiro 2. Available in free and pro versions (you can use RetroArch too)"
          buttons={[
            { label: "Download Free Version", href: "https://play.google.com/store/apps/details?id=org.devmiyax.yabasanshioro2", color: "purple" },
            { label: "Download Pro Version", href: "https://play.google.com/store/apps/details?id=org.devmiyax.yabasanshioro2.pro", color: "purple" },
            { label: "Guide", href: "https://www.youtube.com/watch?v=BJSmPrrwnDU", color: "blue" },
          ]}
        />
      </SectionGroup>
