  ...
  export default function EmulationPage() {
    return (
      ...
      <SectionGroup title="Frontend Launchers">
        <EmuCard system="Emulation Station" note="Coming soon..." buttons={[]} />
        <EmuCard system="Daijisho" note="Coming soon..." buttons={[]} />
        <EmuCard system="Beacon" note="Coming soon..." buttons={[]} />
      </SectionGroup>
    </div>
  );
}
